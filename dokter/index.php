  ...
  <header class="bg-teal-700 text-white shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-6">
        <a href="index.php" class="relative group"><span>Beranda</span></a>
        <a href="artikel.php" class="relative group"><span>Artikel Kesehatan</span></a>
        <a href="obat.php" class="relative group"><span>Obat & Suplemen</span></a>
        <a href="tentang.php" class="relative group"><span>Tentang Kami</span></a>
        <a href="riwayat.php" class="relative group"><span>Riwayat</span></a>
  ...
  <section class="bg-teal-700 text-white py-20 relative overflow-hidden">
    <div class="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center justify-between">
      ...
      <div class="md:w-1/2 text-center md:text-left z-10" data-aos="fade-right">
        ...
        <a href="riwayat.php" class="bg-white text-teal-700 px-6 py-3 rounded-full font-semibold shadow-lg hover:scale-105 transition">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
    ...
    <div onclick="bukaProfil(
      ...
      `<div class='text-left space-y-2 text-sm text-gray-700'>
        ...
        <p><strong>Tarif Konsultasi:</strong> Rp 35.000</p>
    ...
    <div onclick="bukaProfil(
      ...
      `<div class='text-left space-y-2 text-sm text-gray-700'>
        ...
        <p><strong>Tarif Konsultasi:</strong> Rp 40.000</p>
    ...
    <div onclick="bukaProfil(
      ...
      `<div class='text-left space-y-2 text-sm text-gray-700'>
        ...
        <p><strong>Tarif Konsultasi:</strong> Rp 38.000</p>
    ...
    <div onclick="bukaProfil(
      ...
      '../img/dr_afta.jpg',
      `<div class='text-left space-y-2 text-sm text-gray-700'>
        <p><strong>Pengalaman:</strong> 7 tahun</p>
        <p><strong>Rating Pasien:</strong> 87.8%</p>
        <p><strong>Tarif Konsultasi:</strong> Rp 25.000</p>
        <p><strong>Alumnus:</strong><br>Universitas Trisakti, 2014</p>
    ...
    <div onclick="bukaProfil(
      ...
      `<div class='text-left space-y-2 text-sm text-gray-700'>
        ...
        <p><strong>Tarif Konsultasi:</strong> Rp 45.000</p>
